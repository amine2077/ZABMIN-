...
class DiskChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < history.length; i++) {
      spots.add(FlSpot(i.toDouble(), history[i].disk.percent));
    }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Disk Usage (last 60s)', style: GoogleFonts.inter(fontSize: 15, color: Colors.white, fontWeight: FontWeight.w600)),
